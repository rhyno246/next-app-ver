...
const PreviewSliderModal = () => {
  ...
  // Sync swiper với currentIndex khi modal mở
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <button
        className="rotate-180 absolute left-4 p-5 cursor-pointer z-10"
        onClick={handlePrev}
      >
        <svg
          width="36"
      ...
      <button
        className="absolute right-4 p-5 cursor-pointer z-10"
        onClick={handleNext}
      >
        <svg
          width="36"
