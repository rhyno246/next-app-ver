...
export default function ShopPage() {
  ...
  const handleFilterChange = (ids: string[]) => {
    ...
    refetch({
      page: 1,
      pageSize: PAGE_SIZE,
      categories: ids.length > 0 ? ids : undefined,
    });
  };

  const products = data?.products?.data ?? [];
  const currentPage = data?.products?.page ?? 1;
          ...
          <div className="flex gap-7.5">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p>Filters:</p>
                      <button className="text-blue" onClick={handleClearForm}>
                        Clean All
                      </button>
                    </div>
                  </div>
            ...
            <div className="xl:max-w-[870px] w-full">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <p>
                      ...
                      <span className="text-dark">
                        {products.length} of {data?.products.total}
                      </span>{" "}
                      Products
                    </p>
                  </div>
              ...
              <div
                ...
                className="xl:max-w-[870px] w-full"
              >
                <InfiniteScroll
                ...
                {!hasMore && products.length > 0 && (
                  <p className="text-center mt-10 text-dark-4">
                    No more product
                  </p>
                )}
              </div>
